...
/**
 * HTML View class for the Marque Component
 */
class veloViewMarque extends JView
{
	...
	function display($tpl = null)  {
		...
		$pathway->addItem(JText::_('COM_VELO_PROPOSE_MARQUE'), 'index.php?option='.JRequest::getVar('option', '0', 'get', 'string').'&view='.$this->view.'&layout='.$this->layout.'&Itemid='.JRequest::getVar('Itemid', 0, 'get','int'));
