...
/**
 * HTML View class for the Part Component
 */
class veloViewPart extends JView
{
	...
	function display($tpl = null)  {
		...
		$pathway->addItem(JText::_('COM_VELO_PROPOSE_PART'), 'index.php?option='.JRequest::getVar('option', '0', 'get', 'string').'&view='.$this->view.'&layout='.$this->layout.'&Itemid='.JRequest::getVar('Itemid', 0, 'get','int'));
