...
if (JRequest::getVar('print', 0, 'get','int') != 1) : ?>
	<ul class="actions right">
		...
		<?php if ($article_params->get('show_print_icon')) : ?>
			<li class="print-icon"><?php echo JHtml::_('icon.print_popup',  $item, $article_params); ?></li>
		<?php endif; ?>
		<?php if ($article_params->get('show_email_icon')) : ?>
			<li class="email-icon"><?php echo JHtml::_('icon.email',  $item, $article_params); ?></li>
		<?php endif; ?>
...
<div class="velo_details">
	<?php if ($item->photo != '') : ?><img class="left img_large_preview" src=<?php echo $item->photo; ?> /><?php endif; ?>
	...
	<?php foreach ($this->composants as $composant) : ?>
		...
		<div>
			<ul class="actions right">
				<!-- icône modifier -->
				<li><?php echo JHtml::_('icon.edit', '', 'moncomposant', 'edit', $composant, $article_params); ?></li>
				...
				<li><?php echo JHtml::_('icon.attach', '', 'moncomposant', $composant, $article_params); ?></li>
				<!-- icône détacher (mettre en stock) -->
				<li><?php echo JHtml::_('icon.detach', '', 'moncomposant', $composant, $article_params); ?></li>
				<!-- icône supprimer -->
				<li><?php echo JHtml::_('icon.delete', '', 'moncomposant', $composant, $article_params); ?></li>
