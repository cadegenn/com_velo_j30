...
/**
 * veloModelMateriaux List Model
 */
class veloModelMateriaux extends JModelList
{
	/**
	 * Constructor.
	 *
    ...
    protected function getListQuery() {
		...
		$query->from('#__velo_const_materiaux as m');
	...
	*/
	...
	public function getAuthors() {
		...
		$query->join('INNER', '#__velo_const_materiaux AS c ON c.created_by = u.id');
