...
<form action="<?php echo JRoute::_('index.php?option=com_velo&layout=edit&id='.(int) $this->item->id); ?>"
      method="post" name="adminForm" id="marque-form">
	<div class='width-60 fltlft'>
		<fieldset class="adminform">
			<legend><?php echo JText::_( 'COM_VELO_MARQUE_DETAILS' ); ?> <small>(<?php echo $this->item->id; ?>)</small></legend>
			<div class="tr">
	...
	<div>
		<input type="hidden" name="task" value="marque.edit" />
                <?php JFactory::getApplication()->setUserState('com_velo.edit.marque.id', (int) $this->item->id); ?>
