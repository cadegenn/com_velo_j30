...
<form action="<?php echo JRoute::_('index.php?option=com_velo&layout=edit&id='.(int) $this->item->id); ?>"
      method="post" name="adminForm" id="spec-form">
	<div class='width-60 fltlft'>
		<fieldset class="adminform">
			<legend><?php echo JText::_( 'COM_VELO_SPEC_DETAILS' ); ?> <small>(<?php echo $this->item->id; ?>)</small></legend>
			<div class="tr">
			...
			<div class="tr">
				<div class="th"><?php echo $this->form->getField("unit")->label; ?></div>
				<div class="td"><?php echo $this->form->getField("unit")->input; ?></div>
			</div>
		</fieldset>
	</div>
	...
	<div>
		<input type="hidden" name="task" value="spec.edit" />
		<?php JFactory::getApplication()->setUserState('com_velo.edit.spec.id', (int) $this->item->id); ?>
