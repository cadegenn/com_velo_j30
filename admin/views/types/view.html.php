 ...
 * velo View
 */
class veloViewTypes extends JView {
    /**
    ...
    function display($tpl = null)  {
        ...
        $items = $this->get('Items');			// => admin/models/types.php
    ...
    protected function addToolBar() 
    {
        ...
        JToolBarHelper::title(JText::_('COM_VELO').' : '.JText::_('COM_VELO_SUBMENU_TYPES'), 'velo');
        JToolBarHelper::addNewX('type.add');
        JToolBarHelper::editListX('type.edit');
        ...
        JToolBarHelper::deleteListX(JText::_('COM_VELO_AREYOUSURE'), 'types.delete');
        JToolBarHelper::divider();
