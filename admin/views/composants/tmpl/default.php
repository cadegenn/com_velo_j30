...
?>
<form action="<?php echo JRoute::_('index.php?option=com_velo&view=composants'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="adminlist">
        <thead>
			<tr>
				...
				<th><?php echo JHtml::_('grid.sort', 'COM_VELO_ZOOMLEVEL_LABEL', 'm.zoomLevel', $listDirn, $listOrder); ?></th>
